...
public class MainControl {
    ...
    public void configListViewEstados(){
        //Elementos da lista
        try {
    ...
    private void configEditar(Estado newEstado){
    ...
    public void configEditar(){
        activity.getBotaoEditarPaises().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(activity, EditarPaises.class);
